        ...
        <main class="mx-auto max-w-4xl px-6 py-10">
            ...
            <section class="mt-6 rounded-xl bg-white p-8 shadow">
                ...
                <p class="mt-2 text-gray-600">
                    Registra una categoría turística para organizar los destinos.
                </p>

                <form @submit.prevent="guardarCategoria" class="mt-8 space-y-6">
                    <div>
                    ...
                    <div>
                        ...
                        <textarea
                            ...
                            rows="4"
                            class="mt-2 w-full rounded-lg border-gray-300 shadow-sm focus:border-[#0b6fb3] focus:ring-[#0b6fb3]"
                            placeholder="Describe el tipo de destinos que pertenecen a esta categoría"
                        ></textarea>
